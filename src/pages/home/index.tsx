...
const slides = [
  ...
  },
  {
    ...
    accent: 'под ключ',
    desc: 'При заказе оборудования на сумму от 100 000 ₽ — выезд и настройка специалистов в подарок.',
    discount: '0 ₽',
...
const benefits = [
  { icon: '🚚', title: 'Быстрая доставка', text: 'Отправка со склада в день заказа. Доставка по всей России.' },
